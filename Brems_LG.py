...
def integrand(x,omega):
    ...
    for s_f_for in [-0.5,0.5]:
        for lamb_for in [-1,1]:
            curl_L_mod_sq += abs(curl_L(s_for, epsilon_f, theta_f,phi_f, s_f_for, omega, theta_k, phi_k, lamb_for,b_perp0))**2
...
if rank == 0:
    ...
    print("基本参数:")
    print("Z=",Z,"l=",l,"sigma_perp=",sigma_perp,"sigma_z=",sigma_z,"P_z=",P_z,"b_perp0=",b_perp0)
    print("\n积分参数：")
